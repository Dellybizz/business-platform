...
export const guidedStorefrontProfiles=sqliteTable("guided_storefront_profiles",{workspaceId:text("workspace_id").primaryKey().references(()=>workspaces.id),businessType:text("business_type").notNull(),brandName:text("brand_name").notNull(),tagline:text("tagline").notNull(),accentColor:text("accent_color").notNull(),featuredProductIdsJson:text("featured_product_ids_json").notNull().default("[]"),featuredCollectionIdsJson:text("featured_collection_ids_json").notNull().default("[]"),desiredContentJson:text("desired_content_json").notNull().default("[]"),completenessJson:text("completeness_json").notNull().default("{}"),generatedAt:integer("generated_at",{mode:"timestamp_ms"}).notNull(),updatedAt:integer("updated_at",{mode:"timestamp_ms"}).notNull()});
