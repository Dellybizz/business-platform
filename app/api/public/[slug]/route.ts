...
export async function GET(request: Request, { params }: Context) {
  ...
  return Response.json({
    workspace,
    page: {...resolved.page,sections:resolved.page.document.sections,dataSources:resolved.page.document.dataSources,globalTokens:resolved.page.document.globalTokens,document:undefined},
