...
export function createBlock(type:string,presetIndex=0):SiteBlock{const definition=blockRegistry[type];if(!definition)throw new Error(`Unknown block type: ${type}`);const preset=definition.presets[presetIndex]||definition.presets[0];return{id:uniqueId(),type,settings:{...definition.defaults,...preset.settings}}}
